...
import com.chaddevz.micro.sshservice.SocksHttpCore;
...
@Obfuscate
public class SocksHttpApp extends Application implements ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public void onCreate() {
		...
		SkProtect.init(this);
		com.chaddevz.micro.util.Utils.overrideFont(getApplicationContext(), "SERIF", "GoogleSans-Regular.ttf");
	...
	private class AppOpenAdManager {
		...
		private static final String AD_UNIT_ID = "ca-app-pub-8484224253322831/5827103521";
