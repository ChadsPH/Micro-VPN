package com.chaddevz.micro.sshservice.tunnel;

import android.content.Context;
import java.io.IOException;
import com.chaddevz.micro.sshservice.logger.SkStatus;
import android.content.IntentFilter;
import com.chaddevz.micro.sshservice.tunnel.vpn.TunnelVpnService;
import androidx.localbroadcastmanager.content.LocalBroadcastManager;
import java.util.List;
import com.chaddevz.micro.sshservice.tunnel.vpn.VpnUtils;
import android.util.Log;
import com.chaddevz.micro.sshservice.tunnel.vpn.TunnelState;
import android.content.Intent;
import com.chaddevz.micro.sshservice.tunnel.vpn.TunnelVpnSettings;
import android.content.BroadcastReceiver;

import com.chaddevz.micro.sshservice.tunnel.vpn.TunnelVpnManager;
...
import com.chaddevz.micro.sshservice.config.PasswordCache;
		...
		ServerHostKeyVerifier, DebugLogger
{
	...
	*/
	...
	@Override
	public boolean verifyServerHostKey(String hostname, int port, String kexAlgo, String serverHostKeyAlgorithm, byte[] serverHostKey)
	throws Exception {
