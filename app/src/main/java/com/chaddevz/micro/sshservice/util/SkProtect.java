package com.chaddevz.micro.sshservice.util;

import android.content.Context;

import com.chaddevz.micro.BuildConfig;
...
public class SkProtect {
	...
	private static final String APP_BASE = "com.chaddevz.micro";
	...
	public void simpleProtect() {
		if (!APP_BASE.equals(mContext.getPackageName().toLowerCase()) ||
				!mContext.getString(R.string.app_name).toLowerCase().equals("micro vpn")) {
			throw new RuntimeException();
		}
	}
