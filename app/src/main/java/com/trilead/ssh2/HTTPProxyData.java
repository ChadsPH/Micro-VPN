...
public class HTTPProxyData implements ProxyData
{
	...
	private boolean modeDrop = false;
	 ...
	 */
	public HTTPProxyData(String proxyHost, int proxyPort, boolean is)
	{
		this(proxyHost, proxyPort, null, null, null, is);
	}
	 ...
	 */
	public HTTPProxyData(String proxyHost, int proxyPort, String proxyUser, String proxyPass, boolean is)
	{
		this(proxyHost, proxyPort, proxyUser, proxyPass, null, is);
	}
	...
	public HTTPProxyData(String proxyHost, int proxyPort, String proxyUser, String proxyPass,
			String[] requestHeaderLines, boolean isDropBear)
	{
		if (proxyHost == null)
