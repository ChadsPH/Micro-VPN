...
public class Connection
{
	 ...
	 */
	public final static String identification = "TrileadSSH2Java_217";
	...
	public ConnectionInfo connect(ServerHostKeyVerifier verifier, int connectTimeout, int readTimeout, int kexTimeout)
		...
		cryptoWishList.c2s_comp_algos = new String[] { compression ? "zlib@openssh.com" : "none" };
		cryptoWishList.s2c_comp_algos = new String[] { compression ? "zlib@openssh.com" : "none" };
